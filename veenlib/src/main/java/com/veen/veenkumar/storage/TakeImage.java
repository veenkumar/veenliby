package com.veen.veenkumar.storage;
...
public class TakeImage extends Activity {
    ...
    private final String capture_dir = Environment.getExternalStorageDirectory() + "/BhadaAssociate/Images/";
...
//				imageFileUri = FileProvider.getUriForFile(TakeImage.this,BuildConfig.APPLICATION_ID + ".provider",new File(path));
                imageFileUri = FileProvider.getUriForFile(TakeImage.this, "com.bhadaexpress.associateapp", new File(path));
...
//		n = generator.nextInt(n);
        ...
        try {
            ...
            bitmap.compress(Bitmap.CompressFormat.JPEG, 50, out);//	compressing to 50%
            out.flush();
            out.close();
        } catch (Exception e) {
            e.printStackTrace();
