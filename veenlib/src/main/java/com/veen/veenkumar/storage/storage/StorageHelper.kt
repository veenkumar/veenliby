package com.veen.veenkumar.storage.storage
...
object StorageHelper {
    ...
    private const val FOLDER_NAME = "Img"
    ...
    fun createFile(context: Context): String {
        var path = ""
        val capture_dir: String =
            context.externalCacheDir?.absolutePath + "/" + FOLDER_NAME + "/" + IMAGE_FOLDER_NAME + "/"
